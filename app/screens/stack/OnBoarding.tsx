    ...
    return (
        <SafeAreaView style={{ flex: 1, alignItems: "center", backgroundColor: "#fff" }}>
            ...
            <View style={{ marginBottom: 20, rowGap: 20 }}>
                <LargeButton text="Login" color={Colors.light} bg={Colors.violet} functions={() => navigation.navigate("Auth")} />
                <LargeButton text="Next" color={Colors.violet} bg={Colors.violet20} functions={scrollToNextItem} />
            </View>
        </SafeAreaView>
    );
};
